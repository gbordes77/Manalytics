...
class MockDetector:
    ...
    def check_directory(self, directory: Path) -> List[Dict]:
        ...
        ignore_dirs = {
            ...
            'standard_analysis_', 'modern_analysis_', 'pioneer_analysis_', 
            'legacy_analysis_', 'vintage_analysis_', 'pauper_analysis_',
            'analysis_output', 'data/output', 'data/processed', 'data/raw'
        }
