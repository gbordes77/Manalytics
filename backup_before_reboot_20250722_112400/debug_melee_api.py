#!/usr/bin/env python3
"""
Debug de l'API Melee pour voir la réponse exacte
"""
...
def test_melee_api():
    ...
    print("🔍 Test de l'API Melee...")
    print(f"URL: https://melee.gg/Decklist/SearchDecklists")
    print(f"Payload: {json.dumps(payload, indent=2)}")

    try:
        response = requests.post(
            "https://melee.gg/Decklist/SearchDecklists", data=payload, headers=headers
        )
