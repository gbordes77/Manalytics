...
class MTGOScraper(BaseScraper):
    ...
    async def search_mtgo_decklists(
        self, format_name: str, start_date: str, end_date: str
    ) -> List[str]:
    ...
    async def search_mtgo_challenges(
        self, format_name: str, start_date: str, end_date: str
    ) -> List[str]:
            ...
            standings=[
                {
                    ...
                    "losses": 0,
                    "draws": 0,
                    "deck": self.generate_standard_deck()
                    if format_name == "Standard"
                    else self.generate_modern_deck(),
                },
                {
                    "player": "MTGOPlayer2",
                    "rank": 2,
