...
class MtgMeleeConstants:
    ...
    ROUND_PAGE = "https://melee.gg/Tournament/GetStandings"
...
class FilenameGenerator:
    @staticmethod
    def generate_file_name(tournament_id, tournament_name, tournament_date, tournament_format, valid_formats, seat=-1):
