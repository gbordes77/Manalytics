...
class AdvancedMetagameAnalyzer:
    ...
    def perform_statistical_analysis(self) -> Dict:
        ...
        # Nommer les clusters dynamiquement
        cluster_names = {0: 'Populaires', 1: 'Performants', 2: 'Niche', 3: 'Émergents'}
        # Utiliser seulement les noms nécessaires
        active_cluster_names = {i: cluster_names.get(i, f'Groupe {i+1}') for i in range(n_clusters)}
        cluster_analysis['cluster_name'] = cluster_analysis['cluster'].map(active_cluster_names)
