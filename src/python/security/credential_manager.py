...
class SecureCredentialManager:
        ...
        try:
            ...
            for service, encrypted_cred in encrypted_data.items():
                if service == '_metadata':
                    ...
                    decrypted_data = self.cipher.decrypt(encrypted_cred['data'].encode())
    ...
    def store_credential(self, service: str, credential_data: Dict[str, Any], 
                        rotation_days: Optional[int] = None) -> bool:
        """
    ...
    def rotate_credential(self, service: str, new_credential_data: Dict[str, Any]) -> bool:
        """
    ...
    def auto_rotate_credentials(self, rotation_handlers: Dict[str, callable]) -> Dict[str, Any]:
        """
    ...
    def export_credentials(self, services: List[str], export_path: str, 
    ...
    def import_credentials(self, import_path: str, overwrite: bool = False) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            logger.info(f"Import completed: {len(results['imported'])} imported, "
