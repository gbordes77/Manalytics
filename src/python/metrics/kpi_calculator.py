...
class KPICalculator:
    ...
    def calculate_win_rates(self, tournament_data: List[Dict]) -> Dict:
        ...
        for deck in tournament_data:
            ...
            if archetype not in archetype_stats:
                archetype_stats[archetype] = {'total_wins': 0, 'total_losses': 0, 'deck_count': 0}
        ...
        for archetype, stats in archetype_stats.items():
            ...
            win_rates[archetype] = {
                ...
                'avg_wins_per_deck': round(stats['total_wins'] / stats['deck_count'], 2) if stats['deck_count'] > 0 else 0
            }
    ...
    def calculate_temporal_trends(self, tournament_data: List[Dict], days: int = 30) -> Dict:
        """
        ...
        for deck in tournament_data:
            ...
            if deck_date and isinstance(deck_date, str):
                try:
                    deck_datetime = datetime.fromisoformat(deck_date.replace('Z', '+00:00'))
        ...
        return {
            "trend": "growing" if current_diversity["diversity_index"] > 2.0 else "stable",
